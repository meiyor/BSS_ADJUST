...
close all;
rmpath(genpath('/home/jmm_vivobook_asus/DeepGaze_project/eeglab14_1_1b'));
DATA=load(file_path);
...
rmpath(genpath('/home/jmm_vivobook_asus/DeepGaze_project/eeglab14_1_1b/functions/octavefunc'));
%% segment the signal
n=1;
for l=1:2:length(time_a)-2
    ...
    rmpath(genpath('/home/jmm_vivobook_asus/DeepGaze_project/eeglab14_1_1b/fieldtrip-20210507'));
